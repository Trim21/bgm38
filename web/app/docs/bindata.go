...
func swaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "swagger.json", size: 7199, mode: os.FileMode(438), modTime: time.Unix(1576776027, 0)}
...
func swaggerYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "swagger.yaml", size: 3686, mode: os.FileMode(438), modTime: time.Unix(1576776027, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
