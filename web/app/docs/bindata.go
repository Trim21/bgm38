...
func swaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "swagger.json", size: 7415, mode: os.FileMode(420), modTime: time.Unix(1583863933, 0)}
...
func swaggerYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "swagger.yaml", size: 3780, mode: os.FileMode(420), modTime: time.Unix(1583863933, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
