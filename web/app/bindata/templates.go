...
var _bindata = map[string]func() (*asset, error){
	"web/templates/base/head.tmpl": webTemplatesBaseHeadTmpl,
	"web/templates/index.tmpl":     webTemplatesIndexTmpl,
	"web/templates/login.tmpl":     webTemplatesLoginTmpl,
}
	...
	"web": &bintree{nil, map[string]*bintree{
		"templates": &bintree{nil, map[string]*bintree{
			"base": &bintree{nil, map[string]*bintree{
				"head.tmpl": &bintree{webTemplatesBaseHeadTmpl, map[string]*bintree{}},
			}},
			"index.tmpl": &bintree{webTemplatesIndexTmpl, map[string]*bintree{}},
			"login.tmpl": &bintree{webTemplatesLoginTmpl, map[string]*bintree{}},
		}},
	}},
}}
