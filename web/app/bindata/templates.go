...
func baseHeadTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "base/head.tmpl", size: 866, mode: os.FileMode(438), modTime: time.Unix(1575459001, 0)}
