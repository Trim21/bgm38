...
func TestIsBrowser(t *testing.T) {
	for _, h := range []string{
		...
		"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; WOW64; " +
			"Trident/7.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; .NET4.0E)",
		"Mozilla/5.0 (Linux; Android 7.0; MI 5s Plus Build/NRD90M) " +
			"AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.145 Mobile Safari/537.36 EdgA/41.0.0.1273",
